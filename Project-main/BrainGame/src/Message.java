...
public class Message {
    ...
    //Declaring color constant variables
    ...
    public String print(){
        String welcomeMessage= ANSI_YELLOW_BACKGROUND + ANSI_BLACK + "-----------------------------------------------------------\n";
        welcomeMessage=welcomeMessage+"-----------------  B R A I N  G A M E  --------------------\n";
        welcomeMessage=welcomeMessage+"-----------------------------------------------------------\n" + reset;
        welcomeMessage=welcomeMessage+ ANSI_BLUE + "-------Welcome to the game of luck and inteligence!--------\n" + reset;
    ...
    public String print(String msgType){
        switch (msgType) {
            case "intro":
                String gameIntro= ANSI_BLUE + "This is a game that is required not only knowledge and skills but also luck.\n";
                ...
                gameIntro=gameIntro+"Another exciting part is in plan to add, that is your time calculation to compare with other players.\n";
                ...
                return gameIntro;
            case "opt":
                String gameOption= ANSI_GREEN + "----------------------------------\n";
                gameOption=gameOption+"|          GAME OPTIONS          |\n";
    ...
    public String print(String msgType, String playerName, int score, long time){
        ...
        if(msgType=="greet"){
            ...
            greetScore="Player Name: " + ANSI_YELLOW + playerName + reset +"\n";
            greetScore=greetScore+"Total score: " + ANSI_YELLOW + score + reset + "\n";
    ...
    public void prinDieFacet(int die){
        ...
        System.out.println("   ");
        System.out.println(ANSI_WHITE_BACKGROUND + ANSI_BLACK + "      ------" + reset);
        System.out.printf("DIE ->" + ANSI_WHITE_BACKGROUND + ANSI_BLACK + "|  %d  |" + reset, die);
        System.out.println("");
        System.out.println(ANSI_WHITE_BACKGROUND + ANSI_BLACK + "      ------" + reset);
        System.out.println();
    }
