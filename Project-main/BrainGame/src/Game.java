...
public class Game {
    ...
    public void Run(){        
        ...
        System.out.println(ANSI_RED + userMessage.getText() + reset);
        ...
        try{
            if(userInputStream.available()!=0){
                userInput.nextLine();
                System.out.println(ANSI_RED + "Introduction skipped!" + reset);
            }
        }
        catch(Exception e){
            e.printStackTrace();
    ...
    public void getDieOutput(){
        ...
        do{
            ...
            if (letter == 'D') {       
                ...
                System.out.println(ANSI_RED + "Please enter exactly 'D' to roll your die" + reset);
                } 
        }
        while(letter != 'D');
    }
    ...
    public void gameFlow(int die){
        if(newPlayer.getScore()<50){
            if(die==1){
                System.out.println(ANSI_CYAN + "Congratulations " + newPlayer.getName() + "! you have got 10 points by good luck" + reset);
                ...
                System.out.println(ANSI_PURPLE + "Oops! " + newPlayer.getName() + " you have lost 10 points by bad luck.\n" + reset);
                newPlayer.updateScore(-10);
                System.out.println(ANSI_PURPLE +"But you have another chance to try your luck" + reset);
                getDieOutput();
                gameFlow(newPlayer.getDieNumber());
            }
            else if(die==3){
                ...
                System.out.println(ANSI_PURPLE + "Oh! " + newPlayer.getName() + " just try again.\n"+ reset);
                getDieOutput();
                gameFlow(newPlayer.getDieNumber());
            }
        }
        else{
            System.out.println(ANSI_CYAN + "Congratulations " + newPlayer.getName() + "! you have won the game!!\n You are a pround of " + newPlayer.getCountry() + "!\n" + reset);
            System.out.println(userMessage.print("scr", newPlayer.getName(), newPlayer.getScore(), newPlayer.getSpentTime()));
    ...
    public void checkScore(){
        if(newPlayer.getScore()==50){
            ...
            System.out.println(ANSI_CYAN + "Wow " + newPlayer.getName() + "! you have won the game with bonus points!!\n You are a pround of " + newPlayer.getCountry() + "!\n" + reset);
            System.out.println(userMessage.print("scr", newPlayer.getName(), newPlayer.getScore(), newPlayer.getSpentTime()));
            userMessage.print("thx");
        }
        else if(newPlayer.getScore()<50){
            System.out.println(ANSI_PURPLE + "Sorry " + newPlayer.getName() + "! you have lost the game!!\n Try again later\n" + reset);
            System.out.println(userMessage.print("scr", newPlayer.getName(), newPlayer.getScore(), newPlayer.getSpentTime()));
            userMessage.print("thx");
        }
    }
